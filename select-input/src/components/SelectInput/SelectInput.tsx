...
const SelectInput = ({options = [], color, bgColor, onSelect}: SelectInputProps): JSX.Element => {
    ...
    const handleSelectClick = (coffeeId: string, name: string) => {
        setSelectedItem({coffeeId, name})
        setMenuOpen(false)
        onSelect({coffeeId, name})
    }
    ...
    return (
            <div className="select">
                ...
                >
                    {selectedItem ? selectedItem.name : 'Todays\' coffee?'}
